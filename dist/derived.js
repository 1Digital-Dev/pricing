 ...
 */
export const ESSENTIALS_MONTHS_BILLED = Math.round(P.essentials.price_yr / P.essentials.price_mo);
 ...
 */
export const APB_MGD_PER_PAGE_USD = Math.round(APB.managed.retail_usd / APB.managed.pages);
export const APB_WG_PER_PAGE_USD = Math.round(APB.white_glove.retail_usd / APB.white_glove.pages);
/**
 ...
 */
export function formatAuditLogRetention(days) {
    if (days === null)
        return "Unlimited";
 ...
 */
export function changeTurnaround(businessDays) {
