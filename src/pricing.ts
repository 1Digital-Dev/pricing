...
export const PRICING = {
  ...
  ai_visibility: {
    essentials:  { prompts_tracked: 5,  runs_per_month: 1, cadence: "monthly" as const },
    managed:     { prompts_tracked: 15, runs_per_month: 1, cadence: "monthly" as const },
    white_glove: { prompts_tracked: 30, runs_per_month: 1, cadence: "monthly" as const },
    ...
    engines: ["chatgpt", "claude", "perplexity", "gemini"] as const,
  },
